...
class Clash
{
    ...
    public function handle()
    {
        ...
        foreach ($servers as $item) {
            ...
            if ($item['type'] === 'vmess') {
                array_push($proxy, self::buildVmess($user, $item));
                array_push($proxies, $item['name']);
            }
            if ($item['type'] === 'trojan') {
                array_push($proxy, self::buildTrojan($user, $item));
                array_push($proxies, $item['name']);
            }
        }
    ...
    public static function buildVmess($user, $server)
    {
        ...
        if ($server['tls']) {
            ...
            if ($server['tlsSettings']) {
                ...
                else $array['servername'] =  $user['sni'];
            }
        }
        ...
        if ($server['network'] === 'ws') {
            ...
            if ($server['networkSettings']) {
                ...
                if($user['sni'] == NULL)
                    ...
                    else $array['ws-headers'] = ['Host' => $user['sni']];
