window.settings.i18n['vi-VN'] = {
  ...
  '已用流量将在 {reset_day} 日后重置': 'Băng thông còn lại {reset_day} ngày sẽ được reset',
  '已用流量已在今日重置': 'Băng thông đã được đặt lại hôm nay',
  '重置已用流量': 'Đặt lại Băng thông',
  '查看节点状态': 'Xem trạng thái server',
  '当前已使用流量达{rate}%': 'Băng thông hiện tại đã đạt đến{rate}%',
  '节点名称': 'Tên node',
  ...
  '流量明细仅保留近月数据以供查询。': 'Chi tiết băng thông chỉ lưu dữ liệu của những ngày gần đây để truy vấn.',
  '扣费倍率': 'Tỷ lệ',
  '支付手续费': 'Phí thủ tục',
