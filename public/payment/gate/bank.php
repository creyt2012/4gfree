                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="message" id="loginForm">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="info-qr-code">
													...
													<div>SỐ TIỀN: <strong style="color: red;"><font style="font-size:15px"> <?php echo number_format($amount);?>đ</font></strong></div>
														<div>NGÂN HÀNG: <span style="color: blue">MB Bank</span></div>
														<div>SỐ TÀI KHOẢN: <span style="color: GREEN" class="copyclipboard" data-content="<?php echo CONFIG['GATE']['BANK']['ACCOUNT_NUMBER'];?>"><?php echo CONFIG['GATE']['BANK']['ACCOUNT_NUMBER'];?>
														<i class="fa fa-clipboard" aria-hidden="true"></i></span> </div>
														<div>CHỦ TÀI KHOẢN: <span style=""><?php echo CONFIG['GATE']['BANK']['ACCOUNT_NAME'];?></span></div>
													<div class="note-box">
													    
														
														<div>NỘI DUNG CHUYỂN KHOẢN: <span class="code copyclipboard" data-content="<?php echo strtoupper(CONFIG['KEYWORD']);?><?php echo $order_id;?>"><?php echo strtoupper(CONFIG['KEYWORD']);?><?php echo $order_id;?> <i class="fa fa-clipboard" aria-hidden="true"></i></span>
														</div>
                                                    ...
                                                    <p id="status">
                                                        ...
                                                        Vui lòng giữ nguyên trang này, hệ thống sẽ tự động duyệt sau 1~3p...
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="provider">Cung cấp API bởi <a href="https://4gspeed.me">4GSPEED.ME</a></div>
											</div>
										</div>
                                    </div>
                                </div>
